<x-layouts.admin title="Master Menu Option">
                ...
                <table class="table table-zebra w-full">
                    ...
                    <tbody class="text-slate-600">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td>
                                @if ($opt->type === 'select')
                                <div class="badge bg-blue-50 border-none text-blue-600 font-bold text-[10px] px-3 tracking-wider uppercase">
                                    Single Choice
                                </div>
                                @else
                                <div class="badge bg-purple-50 border-none text-purple-600 font-bold text-[10px] px-3 tracking-wider uppercase">
                                    Multiple Choice
                                </div>
                                @endif
                            </td>
        ...
        <div class="modal-box max-w-2xl bg-white">
            <form method="POST" action="{{ route('admin.menu_options.store') }}">
                ...
                <div class="form-control mb-4">
                    ...
                    <input type="text" name="name" placeholder="Contoh: Ukuran atau Topping"
    ...
    <dialog id="edit_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box max-w-2xl bg-white text-slate-800">
            <form method="POST" id="editForm">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h3 class="font-black text-2xl text-slate-800 tracking-tight">Edit Option</h3>
                ...
                <div class="form-control mb-6">
                    <label class="label"><span class="label-text font-bold text-slate-600">Tipe Pemilihan</span></label>
                    <select id="edit_type" name="type" class="select select-bordered w-full">
                        <option value="select">Radio / Select (Hanya 1 pilihan)</option>
                        <option value="checkbox">Checkbox (Bisa pilih banyak)</option>
                    </select>
                </div>
    ...
    <script>
        function openEditModal(btn) {
            ...
            document.getElementById('editForm').action = `/admin/menu_options/${id}`;
