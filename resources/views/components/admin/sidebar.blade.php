<div class="drawer-side is-drawer-close:overflow-visible ">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <!-- Menu item -->
            <li class="{{ request()->routeIs('admin.menus.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.menus.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Menu">
                    <!-- icon Kategori -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <!-- Meja item -->
            <li class="{{ request()->routeIs('admin.tables.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.tables.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Meja">
                    <!-- icon Event -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5h14a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a2 2 0 0 0 0-4V7a2 2 0 0 1 2-2" />
                    </svg>
            ...
            <!-- Order item -->
            <li class="{{ request()->routeIs('admin.orders.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.orders.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Order">
                    <!-- icon Event -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5h14a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a2 2 0 0 0 0-4V7a2 2 0 0 1 2-2" />
                    </svg>
                    <span class="is-drawer-close:hidden">Manajemen Order</span>
                </a>
            </li>

            <!-- Laporan item -->
            <li class="">
                <a href="#" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Laporan">
                    <!-- icon Event -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5h14a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a2 2 0 0 0 0-4V7a2 2 0 0 1 2-2" />
                    </svg>
